#!/bin/bash
# Script pour générer les certificats SSL avec Certbot plugin Nginx
# Usage: sudo ./scripts/generate-ssl-nginx-plugin.sh
...
echo "🔐 Génération des certificats SSL pour $DOMAIN avec Certbot plugin Nginx"
echo ""

# Arrêter temporairement Nginx pour que Certbot puisse utiliser le port 80
echo "⏸️  Arrêt temporaire de Nginx..."
docker compose stop nginx

# Générer les certificats avec Certbot plugin Nginx
